...
public partial class MainWindow : Window
{
    ...
    private void Render()
    {
        ...
        var modelM = Matrix4x4.Multiply(Matrix4x4.CreateTranslation(_offsetX, _offsetY, 0),
                     Matrix4x4.Multiply(Matrix4x4.CreateRotationX(_rotX),
                     Matrix4x4.Multiply(Matrix4x4.CreateRotationY(_rotY),
                     Matrix4x4.Multiply(Matrix4x4.CreateRotationZ(_rotZ), 
